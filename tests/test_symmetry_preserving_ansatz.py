...
def test_x_gate_indices(nqubits, nelectrons, expected):
    test = x_gate_indices(nqubits, nelectrons)
...
def test_a_gate_indices(nqubits, nelectrons, x_gates, expected):
    test = a_gate_indices(nqubits, nelectrons, x_gates)
    assert test == expected
...
def test_symm_preserving_circuit(nqubits, nelectrons):
    ...
    test_circuit = symm_preserving_circuit(nqubits, nelectrons)
