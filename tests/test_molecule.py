...
from qibochem.driver.hamiltonian import (  # fermionic_hamiltonian,; qubit_hamiltonian,; symbolic_hamiltonian,
    parse_pauli_string,
)
...
#
#     # a^\dagger_0 a_0
#     ref_one_body_tensor = np.diag([-1.27785301, -1.27785301, -0.4482997, -0.4482997])
#
#     assert np.isclose(h2_ferm_ham.constant, 0.7559674441714287) # N-N repulsion
...
#     h2_mol_ham = fermionic_hamiltonian(h2.oei, h2.tei, h2.e_nuc)
...
#     ref_sym_ham = SymbolicHamiltonian(
#         -0.0420789764778224
...
#     )
#     assert np.allclose(hamiltonian.matrix, ref_sym_ham.matrix)
